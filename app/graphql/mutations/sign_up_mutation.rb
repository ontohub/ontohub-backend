...
module Mutations
  ...
  class SignUpMutation < AbstractDeviseMutation
    ...
    # V2::Users::AccountController#create and
    ...
    # This is needed for Devise's RegistrationsController#create's internals to
    # work.
    # :nocov:
    def resource_class
      User

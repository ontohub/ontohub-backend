...
Devise.setup do |config|
  ...
  # `secret_key_base` as its `secret_key` by default. You can change it below
  # and use your own secret key.
  # config.secret_key = 'a48de4fb5efd22810beefccd09c3ff31fab3a8f6a5cb50cd4120e6ffb134fd65b71091f50bd226eb34e6096dad95aa0a9f11150410f1ee036599d9f9ee589ce3'
  config.secret_key = 'e1133d5d196775e54fcd20fc18c77285347bf4ca484d199f194aa4aa108b4ad632df0c2d2ed0c881ec61749efb8fe964466532ebf92ebed4c4e2ec52a07e7ef5'
  ...
  # are:
  # :database P= Support basic authentication with authentication key + password
  ...
  # behave the same regardless if the e-mail provided was right or wrong.  Does
  # not affect registerable.
  config.paranoid = true

  # By default Devise will store the user in session. You can skip storage for
  # particular strategies by setting this option.  Notice that if you are
  # skipping storage for all authentication paths, you may want to disable
  # generating routes to Devise's sessions controller by passing skip:
  # :sessions to `devise_for` in your config/routes.rb
  ...
  # ==> Configuration for :database_authenticatable For bcrypt, this is the
  # cost for hashing the password and defaults to 11. If using other
  # algorithms, it sets how many times you want the password to be hashed.
  #
  ...
  # ==> Configuration for :rememberable The time the user will be remembered
  ...
  # ==> Configuration for :timeoutable The time you want to timeout the user
  # session without activity. After this time the user will be asked for
  # credentials again. Default is 30 minutes.
  # config.timeout_in = 30.minutes

  # ==> Configuration for :lockable Defines which strategy will be used to lock
  # an account.
  ...
  # ==> Scopes configuration Turn scoped views on. Before rendering
  # "sessions/new", it will first check for "users/sessions/new". It's turned
  # off by default because it's slower if you are using only default views.
  ...
  # ==> Navigation configuration Lists the formats that should be treated as
  # navigational. Formats like :html, should redirect to the sign in page when
  # the user does not have access, but formats like :xml or :json, should
  # return 401.
  #
  ...
  # ==> OmniAuth Add a new OmniAuth provider. Check the wiki for more
  # information on setting up on your models and hooks.
  # config.omniauth :github, 'APP_ID', 'APP_SECRET', scope: 'user,public_repo'

  # ==> Warden configuration If you want to use other strategies, that are not
  # supported by Devise, or change the failure app, you can configure them
  ...
  # let's call it `MyEngine`, and this engine is mountable, there are some
  # extra configurations to be taken into account.  The following options are
  # available, assuming the engine is mounted as:
  #
